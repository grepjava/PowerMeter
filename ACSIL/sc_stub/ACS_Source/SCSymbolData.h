...
{
	float DailyOpen = 0; // double
	float DailyHigh = 0; // double
	float DailyLow = 0; // double
	unsigned int Old_DailyVolume = 0; // remove
	int DailyNumberOfTrades = 0;
	float LastTradePrice = 0; // double
	uint32_t LastTradeVolume = 0; // double
	...
	float Bid = 0; // double
	float Ask = 0; // double
	unsigned int AskQuantity = 0; // double
	unsigned int BidQuantity = 0; // double
	float CurrencyValuePerTick = 0;
	float SettlementPrice = 0; // double
	...
	int AccumulatedLastTradeVolume = 0; // double
	...
	float LowLimitPrice = 0; // double
	float HighLimitPrice = 0; // double
	uint64_t DailyVolume = 0; // double
